...
#will throw error because of file order
...
ld  --nmagic -t -m elf_i386 -o Kernel/bin/kernel.bin -Ttext 0x2000 Kernel/object/* --oformat binary #Ttext is where the code is put INTO THE DISK ECTOR,
